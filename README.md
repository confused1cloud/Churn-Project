...
| File | Description |
|------|-------------|
| `Untitled18(1).ipynb` | Complete analysis and modeling code |
| `Screenshot 2026=05-25.png` | Excel dashboard screenshot |
...
## Author
[Vedant Santosh Gaikwad]` | Complete analysis and modeling code |
